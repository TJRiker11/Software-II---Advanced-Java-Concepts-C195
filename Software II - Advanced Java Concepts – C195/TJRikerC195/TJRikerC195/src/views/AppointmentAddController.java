...
public class AppointmentAddController implements Initializable {
    ...
    private final ObservableList<String> contacts = FXCollections.observableArrayList("Test", "User", "TJ");
    ...
    // adds appointment if all paramaters are correct
    ...
    // fills in customer name
    public void populateCustomerName(String name) {
        customerName.setText(name);
    }
    // initializes the contact and sets calendar dates that can be selected
    @Override
